                ...
                return (
                    <Reveal key={p.title} delay={(i % 3) * 0.09}>
                        <motion.div
                            ...
                            className="group relative overflow-hidden border border-line rounded-[20px] p-8  bg-white hover:shadow-[0_30px_50px_-24px_rgba(15,23,42,0.28)] hover:border-[rgba(37,99,235,0.45)] transition-normal duration-300"
                        >
                            <motion.div
